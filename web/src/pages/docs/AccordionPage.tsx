  ...
  return (
    <article className="page">
      ...
      <Install
        ...
        importStmt={`import { Accordion } from "FrameUI";`}
      />

      <Section id="overview" title="Overview">
        <p>
          Accordion은 헤더를 클릭하면 그 아래 본문이 펼쳐지고, 다시 누르면
          접히는 패널 묶음입니다. 자주 묻는 질문(FAQ), 약관/정책 문서, 모바일
          사이드바 메뉴, 긴 설정 페이지의 섹션 구분처럼 한 번에 모두 보여주기엔
          양이 너무 많은 정보를 사용자가 필요한 부분만 펼쳐서 읽도록 도와줍니다.
          한 번에 하나만 열리는 single 모드는 사용자의 시선을 한 항목에
          집중시키고, 여러 개를 동시에 열 수 있는 multiple 모드는 여러 패널을
          비교하며 봐야 하는 자리에서 유용합니다.
        </p>
      </Section>

      <Section id="basic-example" title="Basic example">
        <p>
          기본은 <code>type="single"</code>입니다. <code>collapsible</code>을
          켜면 열려있는 항목을 다시 닫을 수 있습니다.
        </p>
        <Example
          preview={
            <Accordion.Root
            ...
            >
              <Accordion.Item value="item-1" className="demo-accordion-item">
                ...
                <Accordion.Content className="demo-accordion-content">
                  A headless React component library.
                </Accordion.Content>
              </Accordion.Item>
              <Accordion.Item value="item-2" className="demo-accordion-item">
                ...
                <Accordion.Content className="demo-accordion-content">
                  Yes — keyboard nav and ARIA are built-in.
                </Accordion.Content>
              </Accordion.Item>
            </Accordion.Root>
          }
      ...
      <Section id="multiple" title="Multiple panels open">
        <p>
          <code>type="multiple"</code>이면 <code>defaultValue</code>는 배열이
          됩니다.
        </p>
        <Example
          preview={
          ...
          rows={[
            {
              ...
              defaultValue: `"single"`,
              description: "한 번에 한 개만 열지, 여러 개를 동시에 열지 결정.",
            },
            {
              prop: "collapsible",
              type: "boolean",
              defaultValue: "false",
              description: `"single" 모드에서 열린 항목을 다시 닫을 수 있는지.`,
            },
            {
              prop: "value / defaultValue",
              type: "string | string[]",
              description: "Controlled / uncontrolled 값. multiple 일 때 배열.",
            },
            {
              prop: "onValueChange",
              type: "(value) => void",
            ...
            },
            {
              ...
              type: "boolean",
              defaultValue: "true",
              description: "키보드 화살표로 끝에 도달했을 때 처음으로 순환.",
            },
          ]}
        />
      </Section>
