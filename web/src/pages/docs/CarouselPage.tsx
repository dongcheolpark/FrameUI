  ...
  return (
    <article className="page">
      ...
      <Install
        ...
        importStmt={`import { Carousel } from "FrameUI";`}
      />

      <Section id="overview" title="Overview">
        <p>
          Carousel은 같은 자리에서 여러 슬라이드를 좌우(또는 상하)로 넘기며
          순차적으로 보여주는 컴포넌트입니다. 홈페이지의 메인 배너/프로모션,
          상품 상세 페이지의 이미지 갤러리, 추천 컨텐츠/리뷰 목록처럼 한정된
          공간에 여러 시각 자료를 압축적으로 노출해야 할 때 사용됩니다. 마우스
          드래그, 모바일 스와이프, 화살표 키, 자동 재생까지 다양한 방식으로
          슬라이드를 넘길 수 있고, 인디케이터로 현재 위치를 알려주거나 원하는
          슬라이드로 바로 점프할 수도 있습니다.
        </p>
      </Section>
      ...
      <Section id="basic-example" title="Basic example">
        <Example
          preview={
            ...
            >
              <Carousel.PrevTrigger className="demo-carousel-btn">
                ‹
              ...
              <Carousel.NextTrigger className="demo-carousel-btn">
                ›
      ...
      <Section id="autoplay" title="Autoplay and loop">
        <p>
          <code>autoplay</code>는 <code>true</code>를 주면 5초 간격으로 자동
          재생되고, 객체 형태로 <code>interval</code>을 지정할 수 있습니다.
          <code>loop</code>를 켜면 끝에서 처음으로 순환합니다. 사용자가{" "}
          <code>prefers-reduced-motion</code>을 켜면 자동 정지합니다.
        </p>
        <Example
          preview={
            <Carousel
          ...
          rows={[
            {
              ...
              type: "number",
              description: "Controlled / uncontrolled 현재 인덱스.",
            },
            {
              prop: "onIndexChange",
              type: "(index: number) => void",
              description: "인덱스가 바뀔 때 호출.",
            },
            {
              prop: "orientation",
              type: `"horizontal" | "vertical"`,
              defaultValue: `"horizontal"`,
              description: "방향. 키보드와 드래그 축이 함께 바뀝니다.",
            },
            {
              prop: "loop",
              type: "boolean",
            ...
            },
            {
              ...
              defaultValue: "false",
              description: "자동 재생. 객체로 ms 단위 간격을 지정.",
            },
            {
              prop: "pauseOnHover",
              type: "boolean",
              defaultValue: "true",
              description: "호버/포커스 시 autoplay 일시정지.",
            },
          ]}
        />
          ...
          rows={[
            {
              ...
              type: "div",
              description: "오버플로우를 숨기고 드래그를 받는 컨테이너.",
            },
            {
              prop: "Carousel.Track",
              type: "div",
              description: "Slide 들을 가로/세로로 배치.",
            },
            {
              prop: "Carousel.Slide",
              type: "div",
              description: "각 슬라이드. 비활성 시 inert + aria-hidden.",
            },
            {
              prop: "Carousel.PrevTrigger / NextTrigger",
              type: "button",
              description:
                "이전/다음 버튼. loop=false일 때 끝에 도달하면 자동 disabled.",
            },
            {
              prop: "Carousel.Indicator",
              type: "button",
              description: `index prop을 받아 해당 슬라이드로 점프.`,
            },
          ]}
        />
      </Section>
